  ...
  try {
    ...
    const html = emailTemplate('📅 New Consultation Request', `
      ...
      <div style="margin-top:24px;">
        ...
        <div style="background-color:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:12px;padding:20px;">
          <p style="color:rgba(255,255,255,0.7);font-size:15px;line-height:1.7;margin:0;white-space:pre-wrap;">${details}</p>
        </div>
      </div>
      ` : ''}
    `);
